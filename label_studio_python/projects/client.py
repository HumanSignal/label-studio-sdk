...
class ProjectsClient:
    ...
    def api_projects_imports_read(
        ...
        client = LabelStudioApi(api_key="YOUR_API_KEY", )
        client.projects.api_projects_imports_read(id=1, import_pk='import_pk', )
        """
        _response = self._client_wrapper.httpx_client.request(
            method="GET",
            url=urllib.parse.urljoin(
    ...
    def api_projects_reimports_read(
        ...
        client = LabelStudioApi(api_key="YOUR_API_KEY", )
        client.projects.api_projects_reimports_read(id=1, reimport_pk='reimport_pk', )
        """
        _response = self._client_wrapper.httpx_client.request(
            method="GET",
            url=urllib.parse.urljoin(
...
class AsyncProjectsClient:
    ...
    async def create(self, *, request: Project, request_options: typing.Optional[RequestOptions] = None) -> Project:
        ...
        client = AsyncLabelStudioApi(api_key="YOUR_API_KEY", )
        await client.projects.create(request=Project(), )
        """
        _response = await self._client_wrapper.httpx_client.request(
            method="POST",
            url=urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "api/projects/"),
    ...
    async def api_projects_imports_read(
        ...
        client = AsyncLabelStudioApi(api_key="YOUR_API_KEY", )
        await client.projects.api_projects_imports_read(id=1, import_pk='import_pk', )
        """
        _response = await self._client_wrapper.httpx_client.request(
            method="GET",
            url=urllib.parse.urljoin(
    ...
    async def api_projects_reimports_read(
        ...
        client = AsyncLabelStudioApi(api_key="YOUR_API_KEY", )
        await client.projects.api_projects_reimports_read(id=1, reimport_pk='reimport_pk', )
        """
        _response = await self._client_wrapper.httpx_client.request(
            method="GET",
            url=urllib.parse.urljoin(
