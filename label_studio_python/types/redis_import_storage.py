...
class RedisImportStorage(pydantic.BaseModel):
    id: typing.Optional[int]
    type: typing.Optional[str]
    synchronizable: typing.Optional[bool]
    path: typing.Optional[str] = pydantic.Field(description="Storage prefix (optional)")
    host: typing.Optional[str] = pydantic.Field(description="Server Host IP (optional)")
    port: typing.Optional[str] = pydantic.Field(description="Server Port (optional)")
    password: typing.Optional[str] = pydantic.Field(description="Server Password (optional)")
    ...
    status: typing.Optional[RedisImportStorageStatus]
    traceback: typing.Optional[str] = pydantic.Field(description="Traceback report for the last failed sync")
    meta: typing.Optional[RedisImportStorageMeta] = pydantic.Field(
    ...
    db: typing.Optional[int] = pydantic.Field(description="Server Database")
