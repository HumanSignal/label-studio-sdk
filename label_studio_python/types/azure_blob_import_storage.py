...
class AzureBlobImportStorage(pydantic.BaseModel):
    id: typing.Optional[int]
    type: typing.Optional[str]
    synchronizable: typing.Optional[bool]
    presign: typing.Optional[bool]
    container: typing.Optional[str] = pydantic.Field(description="Azure blob container")
    prefix: typing.Optional[str] = pydantic.Field(description="Azure blob prefix name")
    ...
    account_name: typing.Optional[str] = pydantic.Field(description="Azure Blob account name")
    account_key: typing.Optional[str] = pydantic.Field(description="Azure Blob account key")
    ...
    status: typing.Optional[AzureBlobImportStorageStatus]
    traceback: typing.Optional[str] = pydantic.Field(description="Traceback report for the last failed sync")
    meta: typing.Optional[AzureBlobImportStorageMeta] = pydantic.Field(
