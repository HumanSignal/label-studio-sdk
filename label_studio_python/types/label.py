...
class Label(pydantic.BaseModel):
    ...
    links: typing.Optional[typing.List[int]]
    ...
    value: LabelValue = pydantic.Field(description="Label value")
    ...
    created_by: int = pydantic.Field(description="User who made this label")
