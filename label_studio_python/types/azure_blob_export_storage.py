...
class AzureBlobExportStorage(pydantic.BaseModel):
    ...
    status: typing.Optional[AzureBlobExportStorageStatus]
    traceback: typing.Optional[str] = pydantic.Field(description="Traceback report for the last failed sync")
    meta: typing.Optional[AzureBlobExportStorageMeta] = pydantic.Field(
