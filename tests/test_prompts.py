...
async def test_batch_failed_predictions(client: LabelStudio, async_client: AsyncLabelStudio) -> None:
    ...
    response = client.prompts.batch_failed_predictions(job_id="job_id", failed_predictions=[])
    validate_response(response, expected_response, expected_types)

    async_response = await async_client.prompts.batch_failed_predictions(job_id="job_id", failed_predictions=[])
...
async def test_batch_predictions(client: LabelStudio, async_client: AsyncLabelStudio) -> None:
    ...
    response = client.prompts.batch_predictions(job_id="job_id", results=[])
    validate_response(response, expected_response, expected_types)

    async_response = await async_client.prompts.batch_predictions(job_id="job_id", results=[])
    validate_response(async_response, expected_response, expected_types)
