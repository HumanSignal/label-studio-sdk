...
async def test_bulk_assign(client: LabelStudio, async_client: AsyncLabelStudio) -> None:
    ...
    response = client.projects.bulk_assign(id=1, assignee=1, task=1)
    validate_response(response, expected_response, expected_types)

    async_response = await async_client.projects.bulk_assign(id=1, assignee=1, task=1)
    validate_response(async_response, expected_response, expected_types)
...
async def test_list_assignments(client: LabelStudio, async_client: AsyncLabelStudio) -> None:
    ...
    response = client.projects.list_assignments(id=1, task_pk=1)
    validate_response(response, expected_response, expected_types)

    async_response = await async_client.projects.list_assignments(id=1, task_pk=1)
    validate_response(async_response, expected_response, expected_types)
...
async def test_assign(client: LabelStudio, async_client: AsyncLabelStudio) -> None:
    ...
    response = client.projects.assign(id=1, task_pk=1, assignee=1, task=1)
    validate_response(response, expected_response, expected_types)

    async_response = await async_client.projects.assign(id=1, task_pk=1, assignee=1, task=1)
    validate_response(async_response, expected_response, expected_types)
...
async def test_delete_assignments(client: LabelStudio, async_client: AsyncLabelStudio) -> None:
    # Type ignore to avoid mypy complaining about the function not being meant to return a value
    assert (
        client.projects.delete_assignments(id=1, task_pk=1)  # type: ignore[func-returns-value]
        is None
    )

    assert (
        await async_client.projects.delete_assignments(id=1, task_pk=1)  # type: ignore[func-returns-value]
        is None
    )
...
async def test_update_assignment(client: LabelStudio, async_client: AsyncLabelStudio) -> None:
    ...
    response = client.projects.update_assignment(id=1, task_pk=1)
    validate_response(response, expected_response, expected_types)

    async_response = await async_client.projects.update_assignment(id=1, task_pk=1)
    validate_response(async_response, expected_response, expected_types)
