...
class SummaryMockup():
    """
    """
    created_labels=json.loads('{"label": {"PER": 1, "ORG": 1}, "sentiment": {"Positive": 1, "Negative": 1}}')
    created_labels_drafts=json.loads('{"label": {"MISC": 1}, "sentiment": {"Negative": 1}}')
    created_annotations=json.loads('{"label|text|labels": 2, "sentiment|text|choices": 2}')
