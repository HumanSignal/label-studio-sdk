...
async def test_create_many(client: LabelStudio, async_client: AsyncLabelStudio) -> None:
    ...
    response = client.tasks.create_many(id=1, request=[TasksCreateManyRequestItem()])
    validate_response(response, expected_response, expected_types)

    async_response = await async_client.tasks.create_many(id=1, request=[TasksCreateManyRequestItem()])
