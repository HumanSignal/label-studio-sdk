...
async def test_list_(client: LabelStudio, async_client: AsyncLabelStudio) -> None:
    ...
    response = client.import_storage.azure_spi.list(ordering="ordering", project=1)
    validate_response(response, expected_response, expected_types)

    async_response = await async_client.import_storage.azure_spi.list(ordering="ordering", project=1)
