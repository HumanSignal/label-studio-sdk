import typing
from label_studio_sdk.core.pagination import SyncPager, AsyncPager, T, R
...
class SyncPagerExt(SyncPager[T, R], typing.Generic[T, R]):
    @classmethod
...
class AsyncPagerExt(AsyncPager[T, R], typing.Generic[T, R]):
    @classmethod
