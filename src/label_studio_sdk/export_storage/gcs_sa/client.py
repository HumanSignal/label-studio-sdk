...
class GcsSaClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        self._raw_client = RawGcsSaClient(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> RawGcsSaClient:
        """
    ...
    def get(self, id: int, *, request_options: typing.Optional[RequestOptions] = None) -> GcssaExportStorage:
        """
        <Card href="https://humansignal.com/goenterprise">
                <img style="pointer-events: none; margin-left: 0px; margin-right: 0px;" src="https://docs.humansignal.com/images/badge.svg" alt="Label Studio Enterprise badge"/>
                <p style="margin-top: 10px; font-size: 14px;">
    ...
    def sync(self, id: int, *, request_options: typing.Optional[RequestOptions] = None) -> GcssaExportStorage:
        """
        <Card href="https://humansignal.com/goenterprise">
                <img style="pointer-events: none; margin-left: 0px; margin-right: 0px;" src="https://docs.humansignal.com/images/badge.svg" alt="Label Studio Enterprise badge"/>
                <p style="margin-top: 10px; font-size: 14px;">
...
class AsyncGcsSaClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._raw_client = AsyncRawGcsSaClient(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> AsyncRawGcsSaClient:
        """
        Retrieves a raw implementation of this client that returns raw responses.
    ...
    async def list(
        ...
        *,
        ...
        async def main() -> None:
            await client.export_storage.gcs_sa.list(
                project=1,
            )
    ...
    async def create(
        ...
        *,
        ...
        async def main() -> None:
            await client.export_storage.gcs_sa.create(
                project=1,
            )
    ...
    async def validate(
        ...
        *,
        ...
        async def main() -> None:
            await client.export_storage.gcs_sa.validate(
                project=1,
            )
    ...
    async def get(self, id: int, *, request_options: typing.Optional[RequestOptions] = None) -> GcssaExportStorage:
        """
        <Card href="https://humansignal.com/goenterprise">
                <img style="pointer-events: none; margin-left: 0px; margin-right: 0px;" src="https://docs.humansignal.com/images/badge.svg" alt="Label Studio Enterprise badge"/>
                <p style="margin-top: 10px; font-size: 14px;">
        ...
        async def main() -> None:
            await client.export_storage.gcs_sa.get(
                id=1,
            )
    ...
    async def delete(self, id: int, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        async def main() -> None:
            await client.export_storage.gcs_sa.delete(
                id=1,
            )
    ...
    async def update(
        ...
        *,
        ...
        async def main() -> None:
            await client.export_storage.gcs_sa.update(
                id=1,
            )
    ...
    async def sync(self, id: int, *, request_options: typing.Optional[RequestOptions] = None) -> GcssaExportStorage:
        """
        <Card href="https://humansignal.com/goenterprise">
                <img style="pointer-events: none; margin-left: 0px; margin-right: 0px;" src="https://docs.humansignal.com/images/badge.svg" alt="Label Studio Enterprise badge"/>
                <p style="margin-top: 10px; font-size: 14px;">
        ...
        async def main() -> None:
            await client.export_storage.gcs_sa.sync(
                id=1,
            )
