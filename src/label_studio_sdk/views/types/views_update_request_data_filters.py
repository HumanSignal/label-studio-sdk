...
class ViewsUpdateRequestDataFilters(UncheckedBaseModel):
    """
    ...
    conjunction: ViewsUpdateRequestDataFiltersConjunction = pydantic.Field()
    """
    ...
    items: typing.List[ViewsUpdateRequestDataFiltersItemsItem] = pydantic.Field()
    """
