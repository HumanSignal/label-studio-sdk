...
class CreateViewsRequestDataFiltersItemsItem(UncheckedBaseModel):
    child_filters: typing.Optional[typing.List[CreateViewsRequestDataFiltersItemsItemChildFiltersItem]] = (
    ...
    filter: CreateViewsRequestDataFiltersItemsItemFilter = pydantic.Field()
    """
    ...
    operator: CreateViewsRequestDataFiltersItemsItemOperator = pydantic.Field()
    """
    ...
    value: CreateViewsRequestDataFiltersItemsItemValue = pydantic.Field()
    """
    Value to filter by
    """
