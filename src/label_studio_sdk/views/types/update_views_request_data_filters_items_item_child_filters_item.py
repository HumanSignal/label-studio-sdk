...
class UpdateViewsRequestDataFiltersItemsItemChildFiltersItem(UncheckedBaseModel):
    filter: UpdateViewsRequestDataFiltersItemsItemChildFiltersItemFilter = pydantic.Field()
    """
    ...
    operator: UpdateViewsRequestDataFiltersItemsItemChildFiltersItemOperator = pydantic.Field()
    """
    ...
    value: UpdateViewsRequestDataFiltersItemsItemChildFiltersItemValue = pydantic.Field()
    """
    Value to filter by
    """
