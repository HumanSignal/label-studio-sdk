...
class UpdateViewsRequestDataFilters(UncheckedBaseModel):
    """
    ...
    conjunction: UpdateViewsRequestDataFiltersConjunction = pydantic.Field()
    """
    ...
    items: typing.List[UpdateViewsRequestDataFiltersItemsItem] = pydantic.Field()
    """
