...
class CreateViewsRequestDataFiltersItemsItemChildFiltersItem(UncheckedBaseModel):
    filter: CreateViewsRequestDataFiltersItemsItemChildFiltersItemFilter = pydantic.Field()
    """
    ...
    operator: CreateViewsRequestDataFiltersItemsItemChildFiltersItemOperator = pydantic.Field()
    """
    ...
    value: CreateViewsRequestDataFiltersItemsItemChildFiltersItemValue = pydantic.Field()
    """
    Value to filter by
    """
