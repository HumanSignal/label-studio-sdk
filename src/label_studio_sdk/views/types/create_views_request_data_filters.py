...
class CreateViewsRequestDataFilters(UncheckedBaseModel):
    """
    ...
    conjunction: CreateViewsRequestDataFiltersConjunction = pydantic.Field()
    """
    ...
    items: typing.List[CreateViewsRequestDataFiltersItemsItem] = pydantic.Field()
    """
