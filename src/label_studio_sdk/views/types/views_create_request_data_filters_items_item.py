...
class ViewsCreateRequestDataFiltersItemsItem(UncheckedBaseModel):
    filter: ViewsCreateRequestDataFiltersItemsItemFilter = pydantic.Field()
    """
    ...
    operator: ViewsCreateRequestDataFiltersItemsItemOperator = pydantic.Field()
    """
    ...
    value: ViewsCreateRequestDataFiltersItemsItemValue = pydantic.Field()
    """
    Value to filter by
    """
