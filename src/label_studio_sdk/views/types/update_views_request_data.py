...
class UpdateViewsRequestData(UncheckedBaseModel):
    """
    Custom view data
    """

    filters: typing.Optional[UpdateViewsRequestDataFilters] = pydantic.Field(default=None)
    """
    ...
    ordering: typing.Optional[typing.List[UpdateViewsRequestDataOrderingItem]] = pydantic.Field(default=None)
    """
