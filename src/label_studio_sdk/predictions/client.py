...
class PredictionsClient:
    ...
    def api_predictions_create(
        ...
        client.predictions.api_predictions_create(
            request=Prediction(
                task=1,
            ),
        )
    ...
    def api_predictions_read(self, id: int, *, request_options: typing.Optional[RequestOptions] = None) -> Prediction:
        """
        ...
        client.predictions.api_predictions_read(
            id=1,
        )
        """
        _response = self._client_wrapper.httpx_client.request(
    ...
    def api_predictions_delete(self, id: int, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        """
        ...
        client.predictions.api_predictions_delete(
            id=1,
        )
        """
        _response = self._client_wrapper.httpx_client.request(
    ...
    def api_predictions_partial_update(
        self, id: int, *, request: Prediction, request_options: typing.Optional[RequestOptions] = None
    ) -> Prediction:
        """
        ...
        client.predictions.api_predictions_partial_update(
            id=1,
            request=Prediction(
                task=1,
            ),
...
class AsyncPredictionsClient:
    ...
    async def api_predictions_create(
        self, *, request: Prediction, request_options: typing.Optional[RequestOptions] = None
    ) -> Prediction:
        """
        Create a prediction for a specific task.
        ...
        await client.predictions.api_predictions_create(
            request=Prediction(
                task=1,
            ),
        )
    ...
    async def api_predictions_read(
        ...
        await client.predictions.api_predictions_read(
            id=1,
        )
        """
        _response = await self._client_wrapper.httpx_client.request(
    ...
    async def api_predictions_delete(self, id: int, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        """
        Delete a prediction by prediction ID.
        ...
        await client.predictions.api_predictions_delete(
            id=1,
        )
        """
        _response = await self._client_wrapper.httpx_client.request(
    ...
    async def api_predictions_partial_update(
        self, id: int, *, request: Prediction, request_options: typing.Optional[RequestOptions] = None
    ) -> Prediction:
        """
        Update prediction data by prediction ID.
        ...
        await client.predictions.api_predictions_partial_update(
            id=1,
            request=Prediction(
                task=1,
            ),
