...
class AsyncRunsClient:
    ...
    async def list(
        ...
        *,
        ...
        async def main() -> None:
            await client.prompts.runs.list(id=1, version_id=1, project=1, project_subset="All", )
        asyncio.run(main())
        """
    ...
    async def create(
        ...
        *,
        ...
        client = AsyncLabelStudio(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.prompts.runs.create(id=1, version_id=1, project=1, project_subset="All", )
        asyncio.run(main())
        """
