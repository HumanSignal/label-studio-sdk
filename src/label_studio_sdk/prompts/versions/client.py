...
class AsyncVersionsClient:
    ...
    async def list(
        ...
        async def main() -> None:
            await client.prompts.versions.list(id=1, )
        asyncio.run(main())
        """
    ...
    async def create(
        ...
        *,
        ...
        client = AsyncLabelStudio(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.prompts.versions.create(id=1, )
        asyncio.run(main())
        """
    ...
    async def get(
        ...
        client = AsyncLabelStudio(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.prompts.versions.get(id=1, version_id=1, )
        asyncio.run(main())
        """
    ...
    async def delete(
        ...
        client = AsyncLabelStudio(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.prompts.versions.delete(id=1, version_id=1, )
        asyncio.run(main())
        """
    ...
    async def update(
        ...
        *,
        ...
        client = AsyncLabelStudio(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.prompts.versions.update(id=1, version_id=1, )
        asyncio.run(main())
        """
    ...
    async def cost_estimate(
        ...
        *,
        ...
        client = AsyncLabelStudio(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.prompts.versions.cost_estimate(prompt_id=1, version_id=1, project_id=1, project_subset=1, )
        asyncio.run(main())
        """
    ...
    async def get_refined_prompt(
        ...
        *,
        ...
        client = AsyncLabelStudio(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.prompts.versions.get_refined_prompt(prompt_id=1, version_id=1, refinement_job_id='refinement_job_id', )
        asyncio.run(main())
        """
    ...
    async def refine_prompt(
        ...
        *,
        ...
        client = AsyncLabelStudio(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.prompts.versions.refine_prompt(prompt_id=1, version_id=1, )
        asyncio.run(main())
        """
