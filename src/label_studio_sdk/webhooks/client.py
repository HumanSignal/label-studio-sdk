    ...
    def update(
        ...
        *,
        ...
        _response = self._raw_client.update(
            id_,
            url=url,
            webhook_serializer_for_update_url=webhook_serializer_for_update_url,
            send_payload=send_payload,
            send_for_all_actions=send_for_all_actions,
            headers=headers,
            is_active=is_active,
            ...
            organization=organization,
            project=project,
            webhook_serializer_for_update_send_payload=webhook_serializer_for_update_send_payload,
            webhook_serializer_for_update_send_for_all_actions=webhook_serializer_for_update_send_for_all_actions,
            webhook_serializer_for_update_headers=webhook_serializer_for_update_headers,
            webhook_serializer_for_update_is_active=webhook_serializer_for_update_is_active,
            webhook_serializer_for_update_actions=webhook_serializer_for_update_actions,
            created_at=created_at,
            updated_at=updated_at,
            request_options=request_options,
        )
...
class AsyncWebhooksClient:
    ...
    async def get(self, id: int, *, request_options: typing.Optional[RequestOptions] = None) -> Webhook:
        ...
        client = AsyncLabelStudio(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.webhooks.get(id=1, )
        asyncio.run(main())
        """
    ...
    async def delete(self, id: int, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        client = AsyncLabelStudio(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.webhooks.delete(id=1, )
        asyncio.run(main())
        """
    ...
    async def update(
        ...
        *,
        ...
        client = AsyncLabelStudio(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.webhooks.update(id_=1, url='url', webhook_serializer_for_update_url='url', )
        asyncio.run(main())
        """
