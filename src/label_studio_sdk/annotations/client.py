...
class AsyncAnnotationsClient:
    ...
    async def get(self, id: int, *, request_options: typing.Optional[RequestOptions] = None) -> Annotation:
        ...
        async def main() -> None:
            await client.annotations.get(id=1, )
        asyncio.run(main())
        """
    ...
    async def delete(self, id: int, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        client = AsyncLabelStudio(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.annotations.delete(id=1, )
        asyncio.run(main())
        """
    ...
    async def update(
        ...
        *,
        ...
        client = AsyncLabelStudio(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.annotations.update(id=1, result=[{'original_width': 1920
            , 'original_height': 1080
            , 'image_rotation': 0
            , 'from_name': 'bboxes'
            , 'to_name': 'image'
    ...
    async def list(
        ...
        client = AsyncLabelStudio(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.annotations.list(id=1, )
        asyncio.run(main())
        """
    ...
    async def create(
        ...
        *,
        ...
        client = AsyncLabelStudio(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.annotations.create(id=1, result=[{'original_width': 1920
            , 'original_height': 1080
            , 'image_rotation': 0
            , 'from_name': 'bboxes'
            , 'to_name': 'image'
