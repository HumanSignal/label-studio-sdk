...
from ...types.organization_member_user import OrganizationMemberUser
...
class MembersClient:
    ...
    def list(
        ...
        *,
    ...
    ) -> SyncPager[OrganizationMemberUser]:
        """
        ...
        if 200 <= _response.status_code < 300:
            _parsed_response = pydantic_v1.parse_obj_as(MembersListResponse, _response.json())  # type: ignore
            _has_next = True
            _get_next = lambda: self.list(
                id, page=page + 1 if page is not None else 1, page_size=page_size, request_options=request_options
            )
    ...
    def delete(self, id: str, user_pk: int, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        """
...
class AsyncMembersClient:
    ...
    async def list(
        ...
        *,
        ...
        page_size: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncPager[OrganizationMemberUser]:
        """
        Retrieve a list of the organization members and their IDs.
    ...
    async def delete(self, id: str, user_pk: int, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        """
        Soft delete a member from the organization.
