...
class OrganizationsClient:
    ...
    def api_fsm_backfill_create(self, *, request_options: typing.Optional[RequestOptions] = None) -> typing.Any:
        """
        ...
        """
        _response = self._raw_client.api_fsm_backfill_create(request_options=request_options)
    ...
    def api_fsm_backfill_status_retrieve(
        self, *, job_id: typing.Optional[int] = None, request_options: typing.Optional[RequestOptions] = None
    ) -> typing.Any:
        """
        <Card href="https://humansignal.com/goenterprise">
                <img style="pointer-events: none; margin-left: 0px; margin-right: 0px;" src="https://docs.humansignal.com/images/badge.svg" alt="Label Studio Enterprise badge"/>
        ...
        """
        _response = self._raw_client.api_fsm_backfill_status_retrieve(job_id=job_id, request_options=request_options)
        return _response.data
...
class AsyncOrganizationsClient:
    ...
    async def api_fsm_backfill_create(self, *, request_options: typing.Optional[RequestOptions] = None) -> typing.Any:
        """
        <Card href="https://humansignal.com/goenterprise">
                <img style="pointer-events: none; margin-left: 0px; margin-right: 0px;" src="https://docs.humansignal.com/images/badge.svg" alt="Label Studio Enterprise badge"/>
                <p style="margin-top: 10px; font-size: 14px;">
        ...
        async def main() -> None:
            await client.organizations.api_fsm_backfill_create()


        asyncio.run(main())
        """
        _response = await self._raw_client.api_fsm_backfill_create(request_options=request_options)
        return _response.data
    ...
    async def api_fsm_backfill_jobs_retrieve(
        ...
        async def main() -> None:
            await client.organizations.api_fsm_backfill_jobs_retrieve()
    ...
    async def api_fsm_backfill_status_retrieve(
        ...
        async def main() -> None:
            await client.organizations.api_fsm_backfill_status_retrieve()


        asyncio.run(main())
        """
        _response = await self._raw_client.api_fsm_backfill_status_retrieve(
            job_id=job_id, request_options=request_options
        )
        return _response.data
