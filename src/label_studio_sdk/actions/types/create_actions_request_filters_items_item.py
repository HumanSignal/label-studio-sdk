...
class CreateActionsRequestFiltersItemsItem(UncheckedBaseModel):
    filter: CreateActionsRequestFiltersItemsItemFilter = pydantic.Field()
    """
    ...
    operator: CreateActionsRequestFiltersItemsItemOperator = pydantic.Field()
    """
