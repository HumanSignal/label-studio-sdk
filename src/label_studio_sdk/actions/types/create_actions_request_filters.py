...
class CreateActionsRequestFilters(UncheckedBaseModel):
    """
    ...
    conjunction: CreateActionsRequestFiltersConjunction = pydantic.Field()
    """
    ...
    items: typing.List[CreateActionsRequestFiltersItemsItem] = pydantic.Field()
    """
