...
class CreateActionsRequestFiltersItemsItemChildFiltersItem(UncheckedBaseModel):
    filter: CreateActionsRequestFiltersItemsItemChildFiltersItemFilter = pydantic.Field()
    """
    ...
    operator: CreateActionsRequestFiltersItemsItemChildFiltersItemOperator = pydantic.Field()
    """
    ...
    value: CreateActionsRequestFiltersItemsItemChildFiltersItemValue = pydantic.Field()
    """
    Value to filter by
    """
