...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "AllRolesProjectListControlWeightsValue": ".types",
    "AnnotatedEnum": ".types",
    "Annotation": ".types",
    ...
    "LseProject": ".types",
    "LseProjectControlWeightsValue": ".types",
    "LseProjectCounts": ".types",
    "LseProjectCreate": ".types",
    "LseProjectCreateControlWeightsValue": ".types",
    "LseProjectCreateRequestControlWeightsValue": ".projects",
    "LseProjectResponse": ".types",
    "LseProjectResponseControlWeightsValue": ".types",
    "LseProjectUpdate": ".types",
    "LseProjectUpdateControlWeightsValue": ".types",
    ...
    "PatchedLseProjectUpdateRequestControlWeightsValue": ".projects",
    "Pause": ".types",
    "PauseRequest": ".types",
    "Prediction": ".types",
    "PredictionRequest": ".types",
    "Project": ".types",
    "ProjectControlWeightsValue": ".types",
    "ProjectGroup": ".types",
