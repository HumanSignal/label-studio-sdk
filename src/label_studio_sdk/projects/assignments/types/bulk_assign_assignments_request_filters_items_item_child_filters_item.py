...
class BulkAssignAssignmentsRequestFiltersItemsItemChildFiltersItem(UncheckedBaseModel):
    filter: BulkAssignAssignmentsRequestFiltersItemsItemChildFiltersItemFilter = pydantic.Field()
    """
    ...
    operator: BulkAssignAssignmentsRequestFiltersItemsItemChildFiltersItemOperator = pydantic.Field()
    """
    ...
    value: BulkAssignAssignmentsRequestFiltersItemsItemChildFiltersItemValue = pydantic.Field()
    """
    Value to filter by
    """
