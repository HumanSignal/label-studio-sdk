...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "BulkTaskAssigneesRequestRequestSelectedItems": ".assignments",
    "BulkTaskAssigneesRequestRequestSelectedItemsExcluded": ".assignments",
    "BulkTaskAssigneesRequestRequestSelectedItemsIncluded": ".assignments",
