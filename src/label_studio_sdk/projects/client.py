...
class ProjectsClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        ...
        self.pauses = PausesClient(client_wrapper=client_wrapper)

        self.exports = ExportsClient(client_wrapper=client_wrapper)
    ...
    def validate_config(
        ...
        """
        _response = self._raw_client.validate_config(id, label_config=label_config, request_options=request_options)
        return _response.data
...
class AsyncProjectsClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        ...
        self.pauses = AsyncPausesClient(client_wrapper=client_wrapper)

        self.exports = AsyncExportsClient(client_wrapper=client_wrapper)
    ...
    async def get(self, id: int, *, request_options: typing.Optional[RequestOptions] = None) -> Project:
        ...
        client = AsyncLabelStudio(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.projects.get(id=1, )
        asyncio.run(main())
        """
    ...
    async def delete(self, id: int, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        client = AsyncLabelStudio(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.projects.delete(id=1, )
        asyncio.run(main())
        """
    ...
    async def update(
        ...
        * If you make changes to the labeling configuration, any tabs that you might have created in the Data Manager are removed.
        ...
        client = AsyncLabelStudio(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.projects.update(id=1, )
        asyncio.run(main())
        """
    ...
    async def import_tasks(
        ...
        *,
        ...
        client = AsyncLabelStudio(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.projects.import_tasks(id=1, request=[{'key': 'value'
            }], )
        asyncio.run(main())
        """
    ...
    async def validate_config(
        ...
        client = AsyncLabelStudio(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.projects.validate_config(id=1, label_config='label_config', )
        asyncio.run(main())
        """
        _response = await self._raw_client.validate_config(
