...
class LseProjectCreateRequestDmColumnDefaults(UncheckedBaseModel):
    """
    ...
    explore: typing.Optional[LseProjectCreateRequestDmColumnDefaultsExplore] = pydantic.Field(default=None)
    """
    Main Data Manager grid.
    """

    labeling: typing.Optional[LseProjectCreateRequestDmColumnDefaultsLabeling] = pydantic.Field(default=None)
    """
    Quick View (reserved).
    """
