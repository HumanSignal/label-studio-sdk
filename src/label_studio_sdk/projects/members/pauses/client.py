...
class AsyncPausesClient:
    ...
    async def list(
        ...
        async def main() -> None:
            await client.projects.members.pauses.list(
                project_pk=1,
                user_pk=1,
            )
    ...
    async def create(
        ...
        *,
        ...
        async def main() -> None:
            await client.projects.members.pauses.create(
                project_pk=1,
                user_pk=1,
                reason="reason",
            )
    ...
    async def get(
        ...
        async def main() -> None:
            await client.projects.members.pauses.get(
                project_pk=1,
                user_pk=1,
                id=1,
            )
    ...
    async def delete(
        ...
        async def main() -> None:
            await client.projects.members.pauses.delete(
                project_pk=1,
                user_pk=1,
                id=1,
            )
    ...
    async def update(
        ...
        *,
        ...
        async def main() -> None:
            await client.projects.members.pauses.update(
                project_pk=1,
                user_pk=1,
                id=1,
                reason="reason",
