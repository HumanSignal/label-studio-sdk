...
class AsyncFileUploadsClient:
    ...
    async def get(self, id: int, *, request_options: typing.Optional[RequestOptions] = None) -> FileUpload:
        ...
        async def main() -> None:
            await client.projects.file_uploads.get(
                id=1,
            )
    ...
    async def delete(self, id: int, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        async def main() -> None:
            await client.projects.file_uploads.delete(
                id=1,
            )
    ...
    async def update(
        ...
        *,
        ...
        async def main() -> None:
            await client.projects.file_uploads.update(
                id=1,
            )
    ...
    async def list(
        ...
        *,
        ...
        async def main() -> None:
            await client.projects.file_uploads.list(
                id=1,
            )
    ...
    async def delete_many(self, id: int, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        async def main() -> None:
            await client.projects.file_uploads.delete_many(
                id=1,
            )
    ...
    async def download(self, filename: str, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        async def main() -> None:
            await client.projects.file_uploads.download(
                filename="filename",
            )
