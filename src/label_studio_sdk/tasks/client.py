...
class TasksClient:
    ...
    def api_tasks_partial_update(
        ...
        client.tasks.api_tasks_partial_update(
            id="id",
            request=TaskSimple(
                data={},
            ),
...
class AsyncTasksClient:
    ...
    async def api_tasks_create(
        ...
        await client.tasks.api_tasks_create(
            request=BaseTask(
                data={},
            ),
        )
    ...
    async def api_tasks_read(
        ...
        await client.tasks.api_tasks_read(
            id="id",
        )
        """
        _response = await self._client_wrapper.httpx_client.request(
    ...
    async def api_tasks_delete(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        await client.tasks.api_tasks_delete(
            id="id",
        )
        """
        _response = await self._client_wrapper.httpx_client.request(
    ...
    async def api_tasks_partial_update(
        ...
        await client.tasks.api_tasks_partial_update(
            id="id",
            request=TaskSimple(
                data={},
            ),
