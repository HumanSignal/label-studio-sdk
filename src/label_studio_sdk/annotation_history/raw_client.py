...
class RawAnnotationHistoryClient:
    ...
    def list_for_project(
        ...
        id: int,
        *,
        created_at_from: typing.Optional[dt.datetime] = None,
        created_at_to: typing.Optional[dt.datetime] = None,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            method="GET",
            params={
                "created_at_from": serialize_datetime(created_at_from) if created_at_from is not None else None,
                "created_at_to": serialize_datetime(created_at_to) if created_at_to is not None else None,
                "page": page,
                "page_size": page_size,
            },
            request_options=request_options,
