...
class RawRedisClient:
    ...
    ) -> HttpResponse[typing.List[RedisImportStorage]]:
        """
    ...
    ) -> HttpResponse[RedisImportStorage]:
        """
...
class AsyncRawRedisClient:
    ...
    async def list(
        self, *, project: typing.Optional[int] = None, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[typing.List[RedisImportStorage]]:
        """
    ...
    async def get(
        self, id: int, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[RedisImportStorage]:
        """
