...
class AsyncLocalClient:
    ...
    async def get(self, id: int, *, request_options: typing.Optional[RequestOptions] = None) -> LocalFilesImportStorage:
        ...
        client = AsyncLabelStudio(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.import_storage.local.get(id=1, )
        asyncio.run(main())
        """
    ...
    async def delete(self, id: int, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        client = AsyncLabelStudio(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.import_storage.local.delete(id=1, )
        asyncio.run(main())
        """
    ...
    async def update(
        ...
        *,
        ...
        client = AsyncLabelStudio(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.import_storage.local.update(id=1, )
        asyncio.run(main())
        """
    ...
    async def sync(
        ...
        client = AsyncLabelStudio(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.import_storage.local.sync(id=1, )
        asyncio.run(main())
        """
