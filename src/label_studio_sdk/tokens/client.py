...
class TokensClient:
    ...
    def refresh(self, *, refresh: str, request_options: typing.Optional[RequestOptions] = None) -> AccessTokenResponse:
        ...
        # Have to use actual httpx client to avoid infinite recursion from
        # refreshing the access token in get_headers call.
        _response = self._client_wrapper.httpx_client.httpx_client.request(
            method="POST",
            url=urllib.parse.urljoin(f"{base_url}/", "/api/token/refresh/"),
            json={"refresh": refresh},
            headers={},  # Don't use auth headers for refresh
        )
