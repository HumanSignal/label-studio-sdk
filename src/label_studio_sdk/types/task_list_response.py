...
class TaskListResponse_LseTask(UncheckedBaseModel):
...
class TaskListResponse_LseTaskSerializerForReviewers(UncheckedBaseModel):
...
class TaskListResponse_LseTaskSerializerForAnnotators(UncheckedBaseModel):
...
TaskListResponse = typing_extensions.Annotated[
    typing.Union[
