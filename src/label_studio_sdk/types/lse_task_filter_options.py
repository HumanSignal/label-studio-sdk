...
class LseTaskFilterOptions(UncheckedBaseModel):
    ...
    * `None` - None
    ...
    finished: typing.Optional[LseTaskFilterOptionsFinished] = pydantic.Field(
        default=None
    )
    """
    ...
    * `None` - None
    ...
    annotated: typing.Optional[LseTaskFilterOptionsAnnotated] = pydantic.Field(
        default=None
    )
    """
    ...
    * `None` - None
    ...
    reviewed: typing.Optional[LseTaskFilterOptionsReviewed] = pydantic.Field(
        default=None
    )
    """
