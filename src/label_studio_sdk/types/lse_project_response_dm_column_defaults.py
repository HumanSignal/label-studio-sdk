...
class LseProjectResponseDmColumnDefaults(UncheckedBaseModel):
    """
    ...
    explore: typing.Optional[LseProjectResponseDmColumnDefaultsExplore] = pydantic.Field(default=None)
    """
    Main Data Manager grid.
    """

    labeling: typing.Optional[LseProjectResponseDmColumnDefaultsLabeling] = pydantic.Field(default=None)
    """
    Quick View (reserved).
    """
