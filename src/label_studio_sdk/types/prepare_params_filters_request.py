...
class PrepareParamsFiltersRequest(UncheckedBaseModel):
    """
    ...
    conjunction: ConjunctionEnum = pydantic.Field()
    """
    ...
    items: typing.List[PrepareParamsFiltersRequestItemsItem] = pydantic.Field()
    """
