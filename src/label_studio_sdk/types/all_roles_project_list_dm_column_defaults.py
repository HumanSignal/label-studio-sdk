...
class AllRolesProjectListDmColumnDefaults(UncheckedBaseModel):
    """
    ...
    explore: typing.Optional[AllRolesProjectListDmColumnDefaultsExplore] = pydantic.Field(default=None)
    """
    Main Data Manager grid.
    """

    labeling: typing.Optional[AllRolesProjectListDmColumnDefaultsLabeling] = pydantic.Field(default=None)
    """
    Quick View (reserved).
    """
