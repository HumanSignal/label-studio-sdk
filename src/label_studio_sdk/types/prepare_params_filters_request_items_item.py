...
class PrepareParamsFiltersRequestItemsItem(UncheckedBaseModel):
    child_filters: typing.Optional[typing.List[PrepareParamsFiltersRequestItemsItemChildFiltersItem]] = pydantic.Field(
        default=None
    )
    """
    ...
    filter: PrepareParamsFiltersRequestItemsItemFilter = pydantic.Field()
    """
    ...
    operator: PrepareParamsFiltersRequestItemsItemOperator = pydantic.Field()
    """
    ...
    value: PrepareParamsFiltersRequestItemsItemValue = pydantic.Field()
    """
    Value to filter by
    """
