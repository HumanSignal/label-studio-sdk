...
class PrepareParamsFiltersRequestItemsItemChildFiltersItem(UncheckedBaseModel):
    filter: PrepareParamsFiltersRequestItemsItemChildFiltersItemFilter = pydantic.Field()
    """
    ...
    operator: PrepareParamsFiltersRequestItemsItemChildFiltersItemOperator = pydantic.Field()
    """
    ...
    value: PrepareParamsFiltersRequestItemsItemChildFiltersItemValue = pydantic.Field()
    """
    Value to filter by
    """
