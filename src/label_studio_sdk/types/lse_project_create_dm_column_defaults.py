...
class LseProjectCreateDmColumnDefaults(UncheckedBaseModel):
    """
    ...
    explore: typing.Optional[LseProjectCreateDmColumnDefaultsExplore] = pydantic.Field(default=None)
    """
    Main Data Manager grid.
    """

    labeling: typing.Optional[LseProjectCreateDmColumnDefaultsLabeling] = pydantic.Field(default=None)
    """
    Quick View (reserved).
    """
