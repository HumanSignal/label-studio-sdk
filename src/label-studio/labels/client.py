...
class LabelsClient:
    ...
    def api_label_links_list(
        ...
        *,
        ...
        label_created_at : typing.Optional[str]
            label\_\_created_at

        label_created_at_gte : typing.Optional[str]
            label**created_at**gte

        label_created_at_lte : typing.Optional[str]
            label**created_at**lte

        label_created_by : typing.Optional[str]
            label\_\_created_by
    ...
    def api_labels_create(
        ...
        Examples
        --------
        from label-studio import LabelCreate
        from label-studio.client import LabelStudioApi

        client = LabelStudioApi(api_key="YOUR_API_KEY", )
        client.labels.api_labels_create(request=[LabelCreate(project=1, from_name='from_name', value={}, title='title', )], )
        """
        _response = self._client_wrapper.httpx_client.request(
            method="POST",
            url=urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "api/labels/"),
    ...
    def api_labels_partial_update(
        ...
        Examples
        --------
        from label-studio import Label
        from label-studio.client import LabelStudioApi

        client = LabelStudioApi(api_key="YOUR_API_KEY", )
        client.labels.api_labels_partial_update(id='id', request=Label(value={}, title='title', created_by=1, organization=1, ), )
        """
        _response = self._client_wrapper.httpx_client.request(
            method="PATCH",
            url=urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", f"api/labels/{jsonable_encoder(id)}/"),
...
class AsyncLabelsClient:
    ...
    async def api_labels_create(
        ...
        client = AsyncLabelStudioApi(api_key="YOUR_API_KEY", )
        await client.labels.api_labels_create(request=[LabelCreate(project=1, from_name='from_name', value={}, title='title', )], )
        """
        _response = await self._client_wrapper.httpx_client.request(
            method="POST",
            url=urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "api/labels/"),
    ...
    async def api_labels_partial_update(
        ...
        client = AsyncLabelStudioApi(api_key="YOUR_API_KEY", )
        await client.labels.api_labels_partial_update(id='id', request=Label(value={}, title='title', created_by=1, organization=1, ), )
        """
        _response = await self._client_wrapper.httpx_client.request(
            method="PATCH",
            url=urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", f"api/labels/{jsonable_encoder(id)}/"),
