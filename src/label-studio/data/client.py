...
class DataClient:
    ...
    def local_files_list(self, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            method="GET",
            url=urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "data/local-files/"),
            params=encode_query(
                jsonable_encoder(
...
class AsyncDataClient:
    ...
    async def local_files_list(self, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        """
        Serving files for LocalFilesImportStorage
