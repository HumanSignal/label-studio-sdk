...
class ExportClient:
    ...
    def api_projects_export_read(
        ...
        *,
        ...
        client.export.api_projects_export_read(id=1, export_type='string', download_all_tasks='string', download_resources=True, ids=1, )
        """
...
class AsyncExportClient:
    ...
    async def api_projects_export_read(
        ...
        *,
        ...
        await client.export.api_projects_export_read(id=1, export_type='string', download_all_tasks='string', download_resources=True, ids=1, )
        """
